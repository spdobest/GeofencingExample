package location.nstech.geofencingexample.spmGeofence;
...
public class AddGeofenceFragment extends DialogFragment {
  ...
  public static AddGeofenceFragment newInstance(double lattitude,double longitude ) {

    Bundle args = new Bundle();
    args.putDouble("lat",lattitude);
  ...
  public void onCreate(@Nullable Bundle savedInstanceState) {
    ...
    lattitude = bundle.getDouble("lat");
    longitude = bundle.getDouble("long");

    Log.i(TAG, "onCreate: "+lattitude+"  "+longitude);
        ...
        positiveButton.setOnClickListener(new View.OnClickListener() {
          ...
          public void onClick(View view) {
            if (dataIsValid()) {
              ...
              getViewHolder().latitudeEditText.setText(lattitude+"");
              getViewHolder().longitudeEditText.setText(longitude+"");

              geofence.name = getViewHolder().nameEditText.getText().toString();
              geofence.latitude = lattitude; //Double.parseDouble(getViewHolder().latitudeEditText.getText().toString());
              geofence.longitude = longitude;// Double.parseDouble(getViewHolder().longitudeEditText.getText().toString());
